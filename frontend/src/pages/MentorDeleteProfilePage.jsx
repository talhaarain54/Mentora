...
function MentorDeleteProfilePage() {
    ...
    const handleDelete = async (e) => {
        ...
        try {
            const response = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/mentor/delete-profile`,
                {
                    headers: {
    ...
    return (
        <div className="px-4 py-14 flex justify-center items-center">
...
export default MentorDeleteProfilePage;
