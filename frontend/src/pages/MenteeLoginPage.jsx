                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
                    ...
                    <div className='w-full flex justify-center items-center gap-7 flex-col'>
                        <div>
                            ...
                            <p className='text-sm md:text-base lg:text-lg mt-2 text-center'>New here? <Link to="/mentee-register" className='text-blue-600' >Create an Account</Link></p>
                        </div>
                        <Link to="/mentor-login" className='text-base md:text-lg lg:text-xl font-semibold bg-blue-800 rounded-lg py-2 w-80 text-center' > Login as a Mentor </Link>
                    </div>
                </form>
            </div>
        </div>
